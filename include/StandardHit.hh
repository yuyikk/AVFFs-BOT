...
public:
    ...
    inline G4ThreeVector GetInPosition() const;
    inline G4ThreeVector GetOutPosition() const;
    inline G4ThreeVector GetVertexPosition() const;
    inline G4ThreeVector GetInMomentum() const;
...
inline G4int StandardHit::GetProcessID() const
{
    return fProcessID;
}

inline G4ThreeVector StandardHit::GetInPosition() const
{
    return fInPos;
}

inline G4ThreeVector StandardHit::GetOutPosition() const
{
    return fOutPos;
}

inline G4ThreeVector StandardHit::GetVertexPosition() const
{
    return fVertexPos;
}

inline G4ThreeVector StandardHit::GetInMomentum() const
{
    return fInMom;
}

inline G4ThreeVector StandardHit::GetOutMomentum() const
{
    return fOutMom;
}
...
inline void StandardHit::SetProcessID(G4int &val)
{
    fProcessID = val;
}

inline void StandardHit::SetInPosition(G4ThreeVector &xyz)
{
    fInPos = xyz;
}

inline void StandardHit::SetOutPosition(G4ThreeVector &xyz)
{
    fOutPos = xyz;
}

inline void StandardHit::SetVertexPosition(G4ThreeVector &xyz)
{
    fVertexPos = xyz;
}

inline void StandardHit::SetInMomentum(G4ThreeVector &pxpypz)
{
    fInMom = pxpypz;
}

inline void StandardHit::SetOutMomentum(G4ThreeVector &pxpypz)
{
    fOutMom = pxpypz;
}
